                            ...
                            <div class="col-md-12">
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <select name="user_id" class="form-control pointer required">
                                            <option value="0" {{ ($data->user_id == 0)? 'selected' : '' }}> اختر العضو </option>
                                            @foreach (App\User::where('confirmed',1)->orderBy('name','asc')->get() as $member)
                                                <option value="{{ $member->id }}" {{ ($data->user_id == $member->id)? 'selected' : '' }}> {{ $member->name }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="amount" value="{{ $data->amount }}" class="form-control required {{ $errors->has('amount')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="desc" value="{{ $data->desc }}" class="form-control required {{ $errors->has('desc')? 'error' : '' }}">
                                        @if ($errors->has('desc'))
                                            <span class="help-block text-danger">
