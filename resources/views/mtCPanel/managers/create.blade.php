...
@section('php')
    @php
        $page = 'managers';
		$folder = 'public/includes/managers';
							...
							<div class="col-md-8">
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        <label>@lang('admin.jobPosition')</label>
                                        <select name="manager_type_id" class="form-control pointer required">
                                            <option value="0" {{ (old('manager_type_id') == 0)? 'selected' : '' }}> المركز الوظيفي </option>
                                            @foreach (App\ManagerType::get() as $m)
                                                <option value="{{ $m->id }}" {{ (old('manager_type_id') == $m->id)? 'selected' : '' }}> {{ $m->title }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
										...
										<input type="text" name="name" value="" class="form-control required {{ $errors->has('name')? 'error' : '' }}">
										@if ($errors->has('name'))
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
										...
										<input type="text" name="nameEn" value="" class="form-control required {{ $errors->has('nameEn')? 'error' : '' }}">
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
										...
										<input type="text" name="title" value="" class="form-control required {{ $errors->has('title')? 'error' : '' }}">
										@if ($errors->has('title'))
											<span class="help-block text-danger">
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
										...
										<input type="text" name="titleEn" value="" class="form-control required {{ $errors->has('titleEn')? 'error' : '' }}">
