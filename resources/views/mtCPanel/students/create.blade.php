...
@section('php')
    @php
        $page = 'students';
        $folder = 'public/includes/students';
			...
			<div class="panel-body">
				<form action="{{ mtGetRoute('store','mtCPanel.'.$page) }}" method="post" enctype="multipart/form-data" data-success="Sent! Thank you!" data-toastr-position="top-right">
					...
					<fieldset>
                        <div class="row">
                            <div class="col-md-8">
								{!! mtTextField(__('admin.stdName'),'stdName',old('stdName'),$errors,['isFirst'=>true]) !!}
								{!! mtTextField(__('admin.stdIndex'),'stdIndex',old('stdIndex'),$errors) !!}
								@php 
								...
								@endphp
								{!! mtSelectField(__('admin.colNo'),'colNo',old('colNo'),$errors,$pagesData) !!}
