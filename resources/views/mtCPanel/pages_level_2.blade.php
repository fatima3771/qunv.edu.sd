...
//CHILD TABLE DEFINITION FOR "Pages Level 2"
                ...
                level2: {
                    ...
                    display: function (data) {
                        ...
                        var $img = $('<label class="label label-primary" style="cursor:pointer">المستوى الثاني <i class="fa fa-fw fa-list"></i></label>');
                ...
                recordsLoaded: function(event, data) {
                    ...
                    $('.jtable-data-row').find('[data-toggle="popover"]').each( function(){
                            ...
                            $(this).popover({
                                ...
                                content : '<img width="100%" src="{{Config::get("mmacpanel.pagesHeadersPath")}}/'+$(this).html()+'" class="thumbnail" alt="" />'
                ...
                formCreated: function (event, data) {
                    ...
                    $('#FileUpload').uploadify({
                        ...
                        'formData'     : {
                            ...
                            'folder'    		: "{{Config::get('mmacpanel.pagesHeadersPath')}}",
                        ...
                        'onUploadSuccess'	 : function(file,data,response) {
                            ...
                            $("#imgArea").html('<input type="hidden" name="headerImage" value="'+file.name+'" /><img src="{{Config::get('mmacpanel.pagesHeadersPath')}}/'+file.name+'" width="100" />');
