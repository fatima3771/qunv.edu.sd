						...
						<tbody>
							@foreach($data as $d)
								<tr>
									...
									<td>
										<a href="{{ mtGetRoute('index','mtCPanel.'.$page.'.'.'details', $d->id) }}" class="btn btn-primary btn-xs btn-3d btn-reveal"><i class="fa fa-exclamation white"></i> <span> @lang('admin.conferences_details') </span> </a>
									
										<a href="{{ mtGetRoute('index','mtCPanel.'.$page.'.'.'pictures', $d->id) }}" class="btn btn-primary btn-xs btn-3d btn-reveal"><i class="fa fa-exclamation white"></i> <span> @lang('admin.conferences_pictures') </span> </a>
									</td>
