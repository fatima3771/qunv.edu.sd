                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-8">
								...
								{!! mtTextAreaField(__('admin.detailsEn'),'txtEn',$data->txtEn,$errors) !!}
								{!! mtTextField(__('admin.country'),'country',$data->country,$errors) !!}
								{!! mtTextField(__('admin.countryEn'),'countryEn',$data->countryEn,$errors) !!}
								{!! mtTextField(__('admin.city'),'city',$data->city,$errors) !!}
								{!! mtTextField(__('admin.cityEn'),'cityEn',$data->cityEn,$errors) !!}
								{!! mtTextField(__('admin.address'),'address',$data->address,$errors) !!}
								{!! mtTextField(__('admin.addressEn'),'addressEn',$data->addressEn,$errors) !!}
								{!! mtTextField(__('admin.start_at'),'start_at',$data->start_at,$errors,['type'=>'date']) !!}
								{!! mtTextField(__('admin.end_at'),'end_at',$data->end_at,$errors,['type'=>'date']) !!}
								{!! mtTextField(__('admin.dataEntry'),'dataEntry',$data->dataEntry,$errors) !!}
