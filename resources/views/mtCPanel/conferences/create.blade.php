                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextAreaField(__('admin.txt'),'txt',old('txt'),$errors) !!}
								{!! mtTextAreaField(__('admin.txtEn'),'txtEn',old('txtEn'),$errors) !!}
								{!! mtTextField(__('admin.country'),'country',old('country'),$errors) !!}
								{!! mtTextField(__('admin.countryEn'),'countryEn',old('countryEn'),$errors) !!}
								{!! mtTextField(__('admin.city'),'city',old('city'),$errors) !!}
								{!! mtTextField(__('admin.cityEn'),'cityEn',old('cityEn'),$errors) !!}
								{!! mtTextField(__('admin.address'),'address',old('address'),$errors) !!}
								{!! mtTextField(__('admin.addressEn'),'addressEn',old('addressEn'),$errors) !!}
								{!! mtTextField(__('admin.start_at'),'start_at',old('start_at'),$errors,['type'=>'date']) !!}
								{!! mtTextField(__('admin.end_at'),'end_at',old('end_at'),$errors,['type'=>'date']) !!}
								{!! mtTextField(__('admin.dataEntry'),'dataEntry',old('dataEntry'),$errors) !!}
