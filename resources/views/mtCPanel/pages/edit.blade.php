                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-8">
								...
								{!! mtTextField(__('admin.link'),'link',$data->link,$errors) !!}
								@php 
								...
								@endphp
								{!! mtSelectField(__('admin.parentPage'),'parent_id',$data->parent_id,$errors,$pagesData) !!}
								@php 
									$publishData = [
								...
								@endphp
								{!! mtRadioField('هل تود نشر الصفحة؟','publish',$data->publish,$errors,$publishData) !!}
								{!! mtTextField(__('admin.order'),'order',$data->order,$errors) !!}
