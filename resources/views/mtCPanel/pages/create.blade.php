                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextField(__('admin.link'),'link',old('link'),$errors) !!}

								@php 
									$pagesData[] = ['selectTitle' => 'عنوان رئيسي', 'selectValue' => 0]; 
									foreach (App\Page::get() as $p){
										$pagesData[] = ['selectTitle' => $p->title, 'selectValue' => $p->id]; 
									}
								@endphp
								{!! mtSelectField(__('admin.parentPage'),'parent_id',old('parent_id'),$errors,$pagesData) !!}
								...
								@endphp
								{!! mtRadioField('هل تود نشر الصفحة؟','publish',old('publish'),$errors, $data= $publishData) !!}
								{!! mtTextField(__('admin.order'),'order',old('order'),$errors) !!}
								{!! mtTextAreaField(__('admin.details'),'txt',old('txt'),$errors) !!}
								{!! mtTextAreaField(__('admin.detailsEn'),'txtEn',old('txtEn'),$errors) !!}
                            </div>
							<div class="col-md-4">
