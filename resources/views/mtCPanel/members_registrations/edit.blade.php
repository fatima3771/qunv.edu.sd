                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="date" name="start_date" value="{{ $data->start_date }}" class="form-control required {{ $errors->has('start_date')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="date" name="end_date" value="{{ $data->end_date }}" class="form-control required {{ $errors->has('end_date')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        <label>هل تود نشر الاستطلاع؟</label>
