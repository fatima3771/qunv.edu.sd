					...
					<table class="table table-striped table-bordered table-hover nomargin">
						<thead>
							<tr>
								...
								<th>@lang('admin.aboutMagazine')</th>
								<th>@lang('admin.publishConditions')</th>
								<th>@lang('admin.editorialBoard')</th>
								<th>@lang('admin.contact')</th>
								<th>@lang('admin.issues')</th>
						...
						<tbody>
							@foreach($data as $d)
								<tr>
									...
									<td>@if($d->publishConditions) <i class="fa fa-fw fa-check text-success"></i> @else <i class="fa fa-fw fa-times text-danger"></i> @endif</td>
									<td>@if($d->editorialBoard) <i class="fa fa-fw fa-check text-success"></i> @else <i class="fa fa-fw fa-times text-danger"></i> @endif</td>
									<td>@if($d->contact) <i class="fa fa-fw fa-check text-success"></i> @else <i class="fa fa-fw fa-times text-danger"></i> @endif</td>
									<td>
										<a href="{{ mtGetRoute('index','mtCPanel.'.$page.'.issues', $d->id) }}" class="btn btn-primary btn-xs"> <i class="fa fa-list" aria-hidden="true"></i> @lang('admin.issues') </a> 
									</td>
									<td width="22%">
