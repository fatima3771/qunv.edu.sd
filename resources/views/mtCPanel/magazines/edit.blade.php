                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextAreaField(__('admin.aboutMagazine'),'txt',$data->txt,$errors) !!}
								{!! mtTextAreaField(__('admin.aboutMagazine').' (En)','txtEn',$data->txtEn,$errors) !!}
								{!! mtTextAreaField(__('admin.publishConditions'),'publishConditions',$data->publishConditions,$errors) !!}
								{!! mtTextAreaField(__('admin.publishConditions').' (En)','publishConditionsEn',$data->publishConditionsEn,$errors) !!}
								{!! mtTextAreaField(__('admin.editorialBoard'),'editorialBoard',$data->editorialBoard,$errors) !!}
								{!! mtTextAreaField(__('admin.editorialBoard').' (En)','editorialBoardEn',$data->editorialBoardEn,$errors) !!}
								{!! mtTextAreaField(__('admin.contact'),'contact',$data->contact,$errors) !!}
								{!! mtTextAreaField(__('admin.contact').' (En)','contactEn',$data->contactEn,$errors) !!}
							</div>
							<div class="col-md-4">
