                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextField(__('admin.titleEn'),'titleEn',old('titleEn'),$errors) !!}
								{!! mtTextField(__('admin.slug'),'slug',old('slug'),$errors) !!}
								{!! mtTextAreaField(__('admin.aboutMagazine'),'txt',old('txt'),$errors) !!}
								{!! mtTextAreaField(__('admin.aboutMagazine').' (En)','txtEn',old('txtEn'),$errors) !!}
								{!! mtTextAreaField(__('admin.publishConditions'),'publishConditions',old('publishConditions'),$errors) !!}
								{!! mtTextAreaField(__('admin.publishConditions').' (En)','publishConditionsEn',old('publishConditionsEn'),$errors) !!}
								{!! mtTextAreaField(__('admin.editorialBoard'),'editorialBoard',old('editorialBoard'),$errors) !!}
								{!! mtTextAreaField(__('admin.editorialBoard').' (En)','editorialBoardEn',old('editorialBoardEn'),$errors) !!}
								{!! mtTextAreaField(__('admin.contact'),'contact',old('contact'),$errors) !!}
								{!! mtTextAreaField(__('admin.contact').' (En)','contactEn',old('contactEn'),$errors) !!}
							</div>
							<div class="col-md-4">
