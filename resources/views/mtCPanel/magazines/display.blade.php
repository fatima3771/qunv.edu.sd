				...
				<div class="table-responsive">
					<table class="table table-striped nomargin">
						<tbody>
                            ...
                            <tr>
                                <th>@lang('admin.aboutMagazine') (En)</th>
                                <td>{!! $data->txtEn !!}</td>
                            </tr>
                            <tr>
                                <th>@lang('admin.publishConditions')</th>
                                <td>{!! $data->publishConditions !!}</td>
                            </tr>
                            <tr>
                                <th>@lang('admin.publishConditions') (En)</th>
                                <td>{!! $data->publishConditionsEn !!}</td>
                            </tr>
                            <tr>
                                <th>@lang('admin.editorialBoard')</th>
                                <td>{!! $data->editorialBoard !!}</td>
                            </tr>
                            <tr>
                                <th>@lang('admin.editorialBoard') (En)</th>
                                <td>{!! $data->editorialBoardEn !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>@lang('admin.contact') (En)</th>
                                <td>{!! $data->contactEn !!}</td>
                            </tr>
                            <tr>
                                <th>@lang('admin.issues')</th>
                                <td><a href="{{ mtGetRoute('index','mtCPanel.'.$page.'.issues',$data->id) }}"> انقر هنا </a></td>
                            </tr>
						</tbody>
						<tfoot>
							<tr>
