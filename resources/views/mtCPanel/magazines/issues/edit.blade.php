                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextField(__('admin.slug'),'slug',$data->slug,$errors) !!}
								{!! mtTextField(__('admin.published_at'),'published_at',$data->published_at,$errors,['type'=>'date']) !!}
								{!! mtTextAreaField(__('admin.welcomeWord'),'txt',$data->txt,$errors) !!}
								{!! mtTextAreaField(__('admin.welcomeWord').' (En)','txtEn',$data->txtEn,$errors) !!}
							</div>
							<div class="col-md-4">
