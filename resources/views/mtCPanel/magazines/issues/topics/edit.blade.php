	...
	<div class="row">
		<div id="panel-1" class="panel panel-default">
			...
			<div class="panel-body">
				<form action="{{ mtGetRoute('update','mtCPanel.'.$page, $gParent->id, $parent->id, $data->id) }}" method="post" enctype="multipart/form-data" data-success="Sent! Thank you!" data-toastr-position="top-right">
                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextField(__('admin.author'),'author',$data->author,$errors,['isFirst'=>true]) !!}
								{!! mtTextField(__('admin.authorEn'),'authorEn',$data->authorEn,$errors) !!}
								{!! mtTextAreaField(__('admin.abstract'),'abstract',$data->abstract,$errors) !!}
								{!! mtTextAreaField(__('admin.abstract').' (En)','abstractEn',$data->abstractEn,$errors) !!}
							</div>
							<div class="col-md-4">
