	...
	<div class="row">
		<div id="panel-1" class="panel panel-default">
			...
			<div class="panel-body">
				<form action="{{ mtGetRoute('store','mtCPanel.'.$page, $gParent->id, $parent->id) }}" method="post" enctype="multipart/form-data" data-success="Sent! Thank you!" data-toastr-position="top-right">
					{{ csrf_field() }}
                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextField(__('admin.author'),'author',old('author'),$errors,['isFirst'=>true]) !!}
								{!! mtTextField(__('admin.authorEn'),'authorEn',old('authorEn'),$errors) !!}
								{!! mtTextAreaField(__('admin.abstract'),'abstract',old('abstract'),$errors) !!}
								{!! mtTextAreaField(__('admin.abstract').' (En)','abstractEn',old('abstractEn'),$errors) !!}
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<div class="col-md-12 col-sm-12">
										<label>@lang('admin.pdf')</label>
...
@section('scripts')
	<script type="text/javascript">
		loadScript(plugin_path + 'dropzone/dropzone.js', function() {
			...
			var folder = "{{ $folder }}/{{ $gParent->id }}/{{ $parentPage_title }}/{{ $parent->id }}";
			// var folder = "{{ $folder.'/'.$gParent->id.'/issues/'.$parent->id }}";
