                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-8">
								...
								{!! mtTextField(__('admin.published_at'),'published_at',old('published_at'),$errors,['type'=>'date']) !!}
								{!! mtTextAreaField(__('admin.welcomeWord'),'txt',old('txt'),$errors) !!}
								{!! mtTextAreaField(__('admin.welcomeWord').' (En)','txtEn',old('txtEn'),$errors) !!}
							</div>
							<div class="col-md-4">
...
@section('scripts')
	<script type="text/javascript">
		loadScript(plugin_path + 'dropzone/dropzone.js', function() {
			...
			var folder = "{{ $folder }}/{{ $parent->id }}/{{ $childPage }}";
