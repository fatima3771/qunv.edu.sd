...
<html lang="en-US">
	<head>
		...
		<!-- CORE CSS -->
		<link href="{{ request()->root() }}/public/assets/admin/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
		<link href="{{ request()->root() }}/public/assets/admin/plugins/bootstrap/RTL/bootstrap-rtl.min.css" rel="stylesheet" type="text/css" />
		
		<!-- THEME CSS -->
		<link href="{{ request()->root() }}/public/assets/admin/css/essentials.css" rel="stylesheet" type="text/css" />
		<link href="{{ request()->root() }}/public/assets/admin/css/layout.css" rel="stylesheet" type="text/css" />
		<link href="{{ request()->root() }}/public/assets/admin/css/layout-RTL.css" rel="stylesheet" type="text/css" />
		<link href="{{ request()->root() }}/public/assets/admin/css/color_scheme/blue.css" rel="stylesheet" type="text/css" id="color_scheme" />
		...
		<!-- Dropzone styles. -->
		<link href="{{ request()->root() }}/public/assets/admin/plugins/dropzone/css/dropzone.css" rel="stylesheet" type="text/css" id="color_scheme" />
	...
	<body>
					...
					<ul class="nav pull-left">
						...
						<li class="dropdown pull-right">
							...
							<ul class="dropdown-menu hold-on-click">
								...
								<li><!-- logout -->
									<a href="{{ route('mtCPanel.logout') }}"><i class="fa fa-power-off"></i> تسجيل الخروج </a>
								</li>
							</ul>
						</li>
						<!-- /USER OPTIONS -->
		...
		<script type="text/javascript" src="{{ request()->root() }}/public/assets/admin/plugins/jquery/jquery-2.2.3.min.js"></script>
		<script type="text/javascript" src="{{ request()->root() }}/public/assets/admin/js/app.js"></script>
		...
		<!-- Sweet Alert -->
		<script src="{{ request()->root() }}/public/assets/sweetalert/js/sweetalert.all.js"></script>
