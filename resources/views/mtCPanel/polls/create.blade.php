                    ...
                    <fieldset>
                        <div class="row">
							<div class="col-md-12">
								...
								{!! mtTextField(__('admin.start_date'),'start_date',old('start_date'),$errors,['type'=>'date']) !!}
								{!! mtTextField(__('admin.end_date'),'end_date',old('end_date'),$errors,['type'=>'date']) !!}
								@php 
									$publishData = [
								...
								@endphp
								{!! mtRadioField('هل تود نشر الاستطلاع؟','publish',old('publish'),$errors,$publishData) !!}
							</div>
						</div>
					</fieldset>
