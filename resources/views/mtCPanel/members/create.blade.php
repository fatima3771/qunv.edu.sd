							...
							<div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <select name="parent_id" class="form-control pointer required">
                                            <option value="0" {{ (old('parent_id') == 0)? 'selected' : '' }}> صفحة رئيسية </option>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="order" value="{{ old('order') }}" class="form-control required {{ $errors->has('order')? 'error' : '' }}">
                                        @if ($errors->has('order'))
                                            <span class="help-block text-danger">
                                                <strong>{{ $errors->first('order') }}</strong>
                                            </span>
