...
<div class="container">
  ...
  <div class="row">
	<div class="col-md-6">
	<h5 class="text-uppercase text-gray-darkgray mb-15">@lang('site.siteName')</h5>
	<div class="double-line-bottom-theme-colored-2"></div>
	<h3 class="font-weight-500 font-30 font- mt-10">@lang('site.welcomeTitle')</h3>
	<p>@lang('site.welcomeTxt')</p>
					  ...
					  <div class="item">
						  <article class="post clearfix mb-30">
							  ...
							  <div class="post-thumb thumb"> 
								  <img src="{{ $n->getPicture() }}" alt="" class="img-responsive img-fullwidth"> 
							  </div>                    
							  <div class="entry-date media-left text-center flip bg-theme-colored border-top-theme-colored2-3px pt-5 pr-15 pb-5 pl-15">
								  <ul>
								  <li class="font-16 text-white font-weight-600">{{ date('d', strtotime($n->getDate())) }}</li>
								  <li class="font-12 text-white text-uppercase">{{ date('M', strtotime($n->getDate())) }}</li>
								  </ul>
							  </div>
							  </div>
							  ...
							  <div class="entry-meta media no-bg no-border mt-0 mb-10">
								  ...
								  <div class="event-content pull-left flip">
									  ...
									  <li><i class="fa fa-calendar mr-5 text-theme-colored2"></i> {{ date('d-m-Y', strtotime($n->getDate())) }}</li>
