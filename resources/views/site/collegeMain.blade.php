@php 
	...
	$latestNews = App\CollegesNews::where('lang',$lang)->where('college_id',$college->id)->orderBy('created_at','DESC')->limit(3)->get();
...
@section('meta-title')
	@lang('site.getContent',['ar'=>$college->title,'en'=>$college->titleEn]) - 
@endsection

@section('collegeTitle')
    <div class="col-xs-12 col-sm-12 col-md-8 pt-10">
	    <h2 class="mt-10">@lang('site.getContent', ['ar'=>$college->title, 'en' => $college->titleEn])</h2>
    </div>
@endsection
...
<div class="container">
  ...
  <div class="row">
	<div class="col-md-6">
	<h5 class="text-uppercase text-gray-darkgray mb-15">@lang('site.getContent', ['ar'=>$college->title, 'en' => $college->titleEn])</h5>
	<div class="double-line-bottom-theme-colored-2"></div>
	<h3 class="font-weight-500 font-30 font- mt-10">@lang('site.welcomeTitle')</h3>
	<p>{!! Str::words(strip_tags(Lang::get('site.getContent', ['ar'=>$college->txt, 'en' => $college->txtEn])),26) !!}</p>
	<div><a href="#" class="btn btn-theme-colored mb-sm-30">@lang('site.more')</a></div>
	</div>
	<div class="col-md-6">
	<div class="box-hover-effect about-video">
	  <div class="effect-wrapper">
	  <div class="thumb">
		<img class="img-responsive img-fullwidth" src="{{ request()->root() }}/public/assets/learnpro/images/youtube-bg.jpg" alt="">
	  </div>
...
<section class="clients bg-theme-colored">
	  ...
	  <div class="row">
		<div class="col-md-12">
			<div class="owl-carousel-4col">
				@foreach(App\Banner::where('publish',1)->orderByRaw('rand()')->limit(4)->get() as $bann)
					<div class="item"><img src="{{ $bann->getPicture() }}" alt=""></div>
				@endforeach
			</div>
		</div>
	  </div>
	...
	<section id="blog">
		<div class="container pb-0">
		  <div class="section-title text-center">
			<div class="row">
			  <div class="col-md-12">
				<h2 class="text-uppercase title">@lang('site.latestNews')</h2>              
						  ...
						  <article class="post clearfix mb-30">
							  ...
							  <div class="entry-meta media no-bg no-border mt-0 mb-10">
								  ...
								  <div class="event-content pull-left flip">
									  <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="{{ $n->getUrl() }}">{{ Str::words(strip_tags($n->title),5) }}</a></h4>
									  <ul class="list-inline">
									  <li><i class="fa fa-calendar mr-5 text-theme-colored2"></i> </li>
							  ...
							  <p class="mt-5">{{ Str::words(strip_tags($n->txt),15) }}</p>
							  <a class="btn btn-default btn-flat font-12 mt-10 ml-5" href="{{ $n->getUrl() }}"> @lang('site.more') </a>
							  </div>
						  </article>
					  </div>
				  @endforeach
  ...
  <section class="parallax layer-overlay overlay-theme-colored-7" dir="ltr" data-bg-img="{{ request()->root() }}/public/assets/learnpro/images/neelain-mosque-bg.jpg" data-parallax-ratio="0.4" style="background-image: url('{{ request()->root() }}/public/assets/learnpro/images/neelain-mosque-bg.jpg'); background-position: 50% 20px;">
