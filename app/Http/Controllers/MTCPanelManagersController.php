...
class MTCPanelManagersController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.managers';
        $this->route = 'mtCPanel.managers';
        $this->model = new Manager;
        $this->folder = '/includes/managers/';
        $this->paginate = 25;
        $this->privName = 'managers';
    }
