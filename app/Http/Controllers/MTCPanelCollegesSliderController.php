...
use Validator;
use App\College;
use App\CollegesSlider;

class MTCPanelCollegesSliderController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.colleges.slider';
        $this->route = 'mtCPanel.colleges.slider';
        $this->model = new CollegesSlider;
        $this->folder = '/includes/colleges/slider';
        $this->paginate = 25;
        $this->privName = 'slider';
