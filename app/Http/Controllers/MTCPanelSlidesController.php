...
class MTCPanelSlidesController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.slides';
        $this->route = 'mtCPanel.slides';
        $this->model = new Slides;
        $this->folder = '/includes/slides/';
        $this->paginate = 25;
        $this->privName = 'slides';
    }
