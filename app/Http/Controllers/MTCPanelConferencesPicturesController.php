...
use Validator;
use App\Conference;
use App\ConferencePictures;

class MTCPanelConferencesPicturesController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.conferences.pictures';
        $this->route = 'mtCPanel.conferences.pictures';
        $this->model = new ConferencePictures;
        $this->folder = '/includes/conferences/pictures';
        $this->paginate = 25;
        $this->privName = 'pictures';
