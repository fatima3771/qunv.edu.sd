                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-8">
								...
								<?php echo mtTextField(__('admin.caption1'),'caption1',$data->caption1,$errors,['isFirst'=>true]); ?>

								<?php echo mtTextField(__('admin.caption2'),'caption2',$data->caption2,$errors); ?>
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        <label><?php echo app('translator')->getFromJson('admin.start_date'); ?></label>
                                        <input type="date" name="start_at" value="<?php echo e(date('Y-m-d', strtotime($data->start_at))); ?>" class="form-control required <?php echo e($errors->has('start_at')? 'error' : ''); ?>">
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        <label><?php echo app('translator')->getFromJson('admin.end_date'); ?></label>
                                        <input type="date" name="end_at" value="<?php echo e(date('Y-m-d', strtotime($data->end_at))); ?>" class="form-control required <?php echo e($errors->has('end_at')? 'error' : ''); ?>">
