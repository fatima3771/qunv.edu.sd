					...
					<table class="table table-striped nomargin">
						<tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($data->caption1); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo app('translator')->getFromJson('admin.caption2'); ?></th>
                                <td><?php echo e($data->caption2); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo app('translator')->getFromJson('admin.start_date'); ?></th>
                                <td><?php echo e($data->start_at); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo app('translator')->getFromJson('admin.end_date'); ?></th>
