				...
				<div class="table-responsive">
					...
					<table class="table table-striped table-bordered table-hover nomargin">
						<thead>
							<tr>
								<th>#</th>
								<th><?php echo app('translator')->getFromJson('admin.url'); ?></th>
								<th><?php echo app('translator')->getFromJson('admin.header'); ?></th>
								<th><?php echo app('translator')->getFromJson('admin.details'); ?></th>
								<th><?php echo app('translator')->getFromJson('admin.display_status'); ?></th>
							</tr>
						</thead>
						<tbody>
